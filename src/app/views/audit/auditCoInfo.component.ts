...
@Component({
  templateUrl: 'auditCoInfo.component.html',
  styles: [
    `
...
export class AuditCoInfoComponent implements OnInit {
  ...
  save() {
    if (!this.isReadOnly) {
      ...
      if (! this.accountInfo['audit'] ) { this.accountInfo['audit'] = {}; }
      if (! this.accountInfo['audit'][this.currentYearString] ) { this.accountInfo['audit'][this.currentYearString] = {}; }
